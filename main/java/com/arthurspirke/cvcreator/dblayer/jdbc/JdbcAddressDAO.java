...
public class JdbcAddressDAO implements AddressDAO {
    private static final String INSERT_ADDRESS = "INSERT INTO address (id, person_id, country_id, region_id, city_id, street_address, postal_code) VALUES (?,?,?,?,?,?,?)";
	...
	public void insert(Address entity) throws ComponentWriteException {
		try(Connection conn = DBConnection.getMySQLConnection(); PreparedStatement pstmt = conn.prepareStatement(INSERT_ADDRESS)){
			...
			pstmt.setInt(4, entity.getRegionId());
			pstmt.setInt(5, entity.getCityId());
			pstmt.setString(6, entity.getStreet());
			pstmt.setInt(7, entity.getPostalCode());
			pstmt.execute();
		} catch(SQLException ex){
