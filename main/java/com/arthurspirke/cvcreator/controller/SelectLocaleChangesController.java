...
import com.arthurspirke.cvcreator.entity.JSONParse;
...
public class SelectLocaleChangesController extends HttpServlet {
 private Logger log = Logger.getLogger(SelectLocaleChangesController.class);
