...
import com.arthurspirke.cvcreator.entity.StaticInfo;
...
public class StaticItemsLocale extends HttpServlet {
	private Logger log = Logger.getLogger(StaticItemsLocale.class); 
